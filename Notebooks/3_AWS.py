...
"""
CNN's go through two phases, a convolutional phase and then a fully connected or dense phase. My convolution phase will have 4 stages each activation function in this phase will be relu, Each kernel size will be 3x3 which will also be the kernel size in the MaxPooling layer. Included padding in each layer because I feel that the edges of each image are important.
"""
